...
const Carousel = () => {
  ...
  let slideImgData = [
    ...
    {
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTSVQZ-6On8rOr72Wy7fQMHlOyWbPFSb08jGfT5MzVP0A&usqp=CAU&ec=48600113"
    },
    {
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3FYQ9UvY2vU8U8xpeoJWy4f3pC2qdO3W3TIHawIW3TA&usqp=CAU&ec=48600113"
    }
  ];
  ...
  return (
    ...
    <button onClick={prevSlide} style={{position:"absolute",top:"50%",color:"white",fontSize:"50px",left:"5%"}}>{"<"}</button>
    <button onClick={nextSlide} style={{position:"absolute",top:"50%",color:"white",fontSize:"50px",right:"5%"}}>{">"}</button>
